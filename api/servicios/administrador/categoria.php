    ...
    if (isset($_SESSION['id_administrador'])) {
        ...
        switch ($_GET['action']) {
            ...
            case 'createRow':
                ...
                if (
                    !$categoria->setNombre($_POST['nombre_categoria']) or
                    !$categoria->setImagen($_FILES['imagen_categoria'])
                ) {
                    ...
                    $result['fileStatus'] = Validator::saveFile($_FILES['imagen_categoria'], $categoria::RUTA_IMAGEN);
                } else {
            ...
            case 'updateRow':
                ...
                if (
                    ...
                    !$categoria->setNombre($_POST['nombre_categoria']) or
                    !$categoria->setImagen($_FILES['imagen_categoria'], $categoria->getFilename())
                ) {
                    $result['error'] = $categoria->getDataError();
                    ...
                    $result['fileStatus'] = Validator::changeFile($_FILES['imagen_categoria'], $categoria::RUTA_IMAGEN, $categoria->getFilename());
                } else {
